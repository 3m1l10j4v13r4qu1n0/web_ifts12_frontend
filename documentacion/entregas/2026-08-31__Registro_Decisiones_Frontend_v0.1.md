...
> Referencia: `documentacion/frontend/acta-decisiones.md`, `docs/logbooks/logbook_legado_01.md`, `documentacion/frontend/{plan,propuesta-tecnologica,dependencias-equipos}.md` y el skill `fe-architect-scaffold`.
...
| DEC-014 | 09/09/2026 | Entregas de `documentacion/entregas/` en formato Markdown (pandoc) además del `.docx` fuente | Disponibilidad versionable y diffable de las entregas | Frontend | Nélida Fernández | Validada |
