...
> **Objetivo:** verificar que los documentos de `docs/driveFrontend/05_infraestructura/`
...
|---|---|---|
| D1 | `espesificacion_tecnica_requerimientos_infraestructura.md` | `docs/frontend/propuesta-tecnologica.md` §6-7 |
| D2 | `cuestionario_moodle_hosting.md` | `docs/frontend/dependencias-equipos.md` §4-5 |
| D3 | `grupo_5_infraestructura.md` | `docs/frontend/propuesta-tecnologica.md`, `src/` (código) |
