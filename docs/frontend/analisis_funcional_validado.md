...
> `docs/driveFrontend/01_analisis_funcional/`:
...
> (ej. `docs/driveFrontend/01_analisis_funcional/grupo_1_analisis_funcional.md` y
> `docs/frontend/auditoria-analisis-unificado.md`). No reemplaza a los PDFs: si hay
