...
| Tema | Decisión |
|---|---|
| Fuente de verdad de endpoints | `docs/sdd/04_historias_usuario/HU-XX/hu_xx_api.md` por historia de usuario (ver skill `fe-architect-scaffold`); rutas base confirmadas en `docs/driveFrontend/04_backend/respuesta.md` |
