...
| **Infraestructura** | Lista final de variables `VITE_*` (¿3 o 6 keys?) (INF-G2) | Habilitar `.env.example` y migrar a `import.meta.env` | Infra + Frontend | Pendiente (recordatorio: `docs/driveFrontend/05_infraestructura/bloqueo_infra.md`) |
