...
fuente de verdad de navegación es `documentacion/driveFrontend/02_ux_ui/mapa_sitio_ifts12_(V2).md`
...
(`documentacion/driveFrontend/04_backend/respuesta.md`): **prefijo `/api/`**, rutas públicas GET
...
- Frontend se entrega como **build estático** (`dist/`) para servir desde Nginx en un VPS
  independiente del Moodle (Plan B). Detalle en `documentacion/frontend/propuesta-tecnologica.md`.
...
- `documentacion/frontend/propuesta-tecnologica.md` §6 alineado con la especificación técnica de
...
- Pendientes multi-equipo para la reunión del lunes 31/08: minuta V2 de Análisis, wireframes
  ...
  Moodle/inscripción (`documentacion/frontend/dependencias-equipos.md`).
- **Auditoría de UX/UI** contra los documentos nuevos de `documentacion/driveFrontend/02_ux_ui/`
  (V1 + Mapa V2 + wireframes) **completada** (`docs/06_audits/audit_2026-09-21-ux-ui.md`, rama
...
- **Auditoría** contra `Analisis funcional todo unificado IFTS 12.pdf` **completada**
  (`docs/06_audits/audit_2026-09-18-analisis-funcional.md`, rama `feature/auditoria-analisis-unificado`):
...
- **Auditoría de análisis funcional contra la fuente única de verdad validada** (18/09/2026)
  **completada** (`docs/06_audits/audit_2026-09-18-analisis-funcional.md` v2, rama
  `feature/auditoria-fuente-analisis`): se actualizaron `grupo_1_analisis_funcional.md`,
  `grupo_3_frontend.md`, `documentacion/frontend/{dependencias-equipos,acta-decisiones}.md`. Pendiente
...
- **Auditoría de infraestructura** contra los 3 documentos de `documentacion/driveFrontend/05_infraestructura/`
  **completada** (`docs/06_audits/audit_2026-09-09-infraestructura.md`, rama
...
- **Auditoría de backend** contra `documentacion/driveFrontend/04_backend/respuesta.md` **completada**
  (`docs/06_audits/audit_2026-09-15-backend.md`, rama `feature/auditoria-backend`): rutas `/api/`
...
- `documentacion/frontend/analisis_funcional_validado.md` — **Fuente única de verdad de Análisis
  Funcional, validada por el cliente el 18/09/2026**: síntesis de los 3 PDFs aprobados en
  `documentacion/driveFrontend/01_analisis_funcional/` (Documento Consolidado, Respuesta a Frontend, PP
...
- `docs/06_audits/audit_2026-09-18-analisis-funcional.md` — **Auditoría v2 (18/09/2026)** contra
...
- `documentacion/driveFrontend/01_analisis_funcional/Analisis funcional todo unificado IFTS 12 (2).pdf` — PDF fuente del
  Consolidado (8 partes), entre los 3 aprobados. Los PDFs mandan ante contradicción.
- `docs/06_audits/audit_2026-09-09-infraestructura.md` — Auditoría de consistencia entre los
  requerimientos de infraestructura (`documentacion/driveFrontend/05_infraestructura/`: especificación
...
- `docs/06_audits/audit_2026-09-15-backend.md` — Auditoría de la respuesta de Backend
  (`documentacion/driveFrontend/04_backend/respuesta.md`) contra el estado real del frontend. 14
...
- `documentacion/entregas/` — entregables de cierre de fases (acta de roles, inventario técnico,
  ...
  **Markdown** (pandoc, 09/09/2026) además del `.docx` fuente; matriz, registro y reporte
  ...
  `documentacion/driveFrontend/05_infraestructura/bloqueo_infra.md` (no versionado).
- `documentacion/driveFrontend/02_ux_ui/` — **Documentación UX/UI actualizada (21/09/2026)**:
  ...
  - **Wireframes (nueva ubicación versionable):** `documentacion/wireframes/` — 16 pantallas HTML de
    ...
    Movidos desde `documentacion/driveFrontend/02_ux_ui/wireframe/` (gitignored) para poder versionarlos;
    los buscas en navegación local abriendo `documentacion/wireframes/index.html`. **Siguen siendo la
    fuente de verdad de navegación** junto con el V2.
  - Auditoría: `docs/06_audits/audit_2026-09-21-ux-ui.md` (hallazgos UX-A1…UX-A10).
- `docs/01_global/`, `docs/02_technical/`, `docs/03_process/` y
  `docs/04_user_stories/HU-01/` — **base de documentación SDD completada (18/09/2026)**:
  ...
  (`README.md`, caso de uso expandido, modelos de datos, `hu_01_api.md` con endpoints `GET` de la
...
- `.opencode/skills/fe-architect-scaffold/SKILL.md` — **actualizado 18/09/2026**: la lista de
  ...
  (`docs/04_user_stories/HU-XX/hu_xx_api.md`) y crece automáticamente con cada HU nueva.

## 9. Documentos de dependencias por grupo

- `documentacion/driveFrontend/01_analisis_funcional/grupo_1_analisis_funcional.md` — Qué pedirle a Análisis
...
- `documentacion/driveFrontend/02_ux_ui/grupo_2_ux_ui.md` — Qué pedirle a UX/UI (wireframes, paleta
...
- `documentacion/driveFrontend/03_frontend/grupo_3_frontend.md` — Estado de Frontend, qué ya entregamos, qué
  necesitamos de otros, y qué les entregamos a ellos.
- `documentacion/driveFrontend/04_backend/grupo_4_backend.md` — Qué pedirle a Backend (tabla de endpoints, esquemas
  de datos, códigos de error, autenticación, datos de prueba, tecnología confirmada).
- `documentacion/driveFrontend/05_infraestructura/grupo_5_infraestructura.md` — Qué pedirle a Infra (VPS, dominio, Nginx,
  variables de entorno, backups, monitoreo, estrategia de ambientes).
- `documentacion/driveFrontend/06_qa/grupo_6_qa.md` — Qué pedirle a QA (ambiente de testing, plan de testing,
...
- No inventar endpoints, campos, textos ni contenido institucional; la Home usa mocks marcados
  como provisorios.
- Stack fijado y documentado en `documentacion/frontend/propuesta-tecnologica.md`; backend de referencia
  Python/Flask + Gunicorn + Nginx + PostgreSQL (Plan B).
- `documentacion/driveFrontend/` no se versiona (gitignored), pero su contenido es fuente de verdad.
...
- La fuente de verdad de endpoints del frontend es **por historia de usuario**:
  `docs/04_user_stories/HU-XX/hu_xx_api.md` (skill `fe-architect-scaffold` actualizado
