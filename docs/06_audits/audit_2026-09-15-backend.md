...
> Fuente auditada: `documentacion/driveFrontend/04_backend/respuesta.md` (definiciones técnicas
> formales del equipo de Backend)
> Estado real relevado: código actual en `develop` (rama `feature/auditoria-backend`),
> `src/`, `documentacion/frontend/` y `docs/02_technical/estado_implementacion.md`.
...
`documentacion/driveFrontend/04_backend/grupo_4_backend.md` (fuente de verdad, NO versionada):
...
- `documentacion/driveFrontend/04_backend/respuesta.md` — respuesta formal de Backend (15/09/2026).
- `documentacion/driveFrontend/04_backend/grupo_4_backend.md` — doc del grupo actualizado en esta auditoría.
- `src/api/client.ts`, `src/api/endpoints.ts`, `src/types/api/error.types.ts` — estado real del código.
- `documentacion/frontend/dependencias-equipos.md` §3 — dependencias de Backend (actualizado).
- `docs/02_technical/estado_implementacion.md` — foto de estado (actualizada en esta auditoría).