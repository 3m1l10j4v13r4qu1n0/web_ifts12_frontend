...
Se adapta del proceso ágil del proyecto (método Kanban, `docs/05_agile_methodology/`) e
...
- [ ] Tiene el formato estándar (**Como… quiero… para…**) y describe al actor según
      `docs/01_global/actores.md`.
- [ ] Está dentro del alcance definido en `docs/01_global/alcance.md` y no contradice
      las reglas de negocio transversales de `docs/01_global/reglas_negocio.md`.
...
- [ ] Tiene especificado el/los endpoint/s de API a consumir en su archivo `hu_XX_api.md`
      ...
      (`documentacion/driveFrontend/04_backend/respuesta.md`) y la fuente por historia de usuario
...
- Cada HU nueva crea su carpeta `docs/04_user_stories/HU-XX/` con los archivos
...
Equipo del proyecto. (2026). Metodología Kanban. `docs/05_agile_methodology/metodoKanban.md`.
